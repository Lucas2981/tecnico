    ...
    <footer className="bg-ppal pt-5">
      <div className="padding-container max-container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          ...
          <div className="text-color-h5 flex flex-wrap gap-10 sm:justify-between md:flex-1">
            {FOOTER_LINKS.map((columns) => (
              <FooterColumn title={columns.title}>
                <ul className="text-color-h6 flex flex-col gap-4">
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  <Link
                    ...
                    <p className="whitespace-nowrap text-color-h6">
                      {link.label}:
                    </p>
                    <p className="medium-14 whitespace-nowrap text-color-h6">
                      {link.value}
                    </p>
                  </Link>
                ))}
